...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided@v0.3.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-strided@v0.3.1-umd/browser.js"></script>
```
