...
```javascript
import { arcsine, beta, discreteUniform, exponential, lognormal, minstd, mt19937, normal, randu, uniform } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided@esm/index.mjs';
```
